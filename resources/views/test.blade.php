            ...
            <div>
                ...
                <div>
                    ...
                    <a href="{{route('login')}}" style="color: crimson;">
                        <button class="like"> <i class="fa fa-heart" aria-hidden="true"></i>&ensp;<span>Like</span>&ensp;{{$post->likes->count()}}</button>
                    </a>
                    ...
                    <a href="{{route('manager.unlike.post',['postid' => $post->id])}}" style="color: crimson;">
                        ...
                        <a href="{{route('admin.unlike.post',['postid' => $post->id])}}" style="color: crimson;">
                            @endif
                            <button class="like"> <i class="fa fa-heart" aria-hidden="true"></i>&ensp;<span>UnLike</span>&ensp;{{$post->likes->count()}}</button>
                        </a>
