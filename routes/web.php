...
Route::group([
    ...
    Route::get('/member/{id}/edit', 'AdminPanelController@editmember')->middleware('verified')->name('user.edit');
    Route::post('/member/{id}/confirm', 'AdminPanelController@confirmMember')->middleware('verified')->name('user.edit.confirm');
    Route::post('/member/{id}/update', 'AdminPanelController@updateusers')->middleware('verified')->name('user.update');
    Route::get('/member/{id}/delete', 'AdminPanelController@destroyusers')->middleware('verified')->name('user.delete');

    //--------Managing Users------------------------//

    //--------Managing Managers------------------------//
    Route::get('/manager/lists', 'AdminPanelController@managers')->middleware('verified')->name('manager.list');
    Route::get('/manager/{id}/edit', 'AdminPanelController@editmanager')->middleware('verified')->name('manager.edit');
    Route::post('/manager/{id}/confirm', 'AdminPanelController@confirmManager')->middleware('verified')->name('manager.edit.confirm');
    Route::post('/manager/{id}/update', 'AdminPanelController@updatemanagers')->middleware('verified')->name('manager.update');
    Route::get('/manager/{id}/delete', 'AdminPanelController@destroymanagers')->middleware('verified')->name('manager.delete');

    //--------Managing Managers------------------------//

    //--------Managing Admins------------------------//
    Route::get('/{id}/lists', 'AdminPanelController@admins')->middleware('verified')->name('admin.list');
    Route::get('/admin/{id}/edit', 'AdminPanelController@editadmin')->middleware('verified')->name('admin.edit');
    Route::post('/admin/{id}/confirm', 'AdminPanelController@confirmforAdmin')->middleware('verified')->name('admin.edit.confirm');
    Route::post('/admin/{id}/update', 'AdminPanelController@updateadmins')->middleware('verified')->name('admin.update');
    Route::get('/admin/{id}/delete', 'AdminPanelController@destroyadmins')->middleware('verified')->name('admin.delete');
...
Route::group([
    ...
    //--------Report------------------------//
    Route::get('/lists/lists', 'AdminPanelController@Reports')->middleware('verified')->name('reports.admin.list');
